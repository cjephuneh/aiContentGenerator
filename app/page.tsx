...
export default function Home() {
  return (
    <div>
      <Head>
        <title>AI Content Generator - Revolutionize Your Content Creation</title>
        <meta name="description" content="Revolutionize your content creation with our AI-powered app, delivering engaging and high-quality text in seconds." />
        <meta name="keywords" content="AI, content generator, AI-powered app, content creation, high-quality text" />
